...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_62570 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_62570(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_62574 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_62574(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62582 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62582(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62587 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62587(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62598 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62598(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62605 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62605(reader);
}
});
...
var G__62762 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__62763 = s.append(c);
c = G__62762;
s = G__62763;
continue;
}
