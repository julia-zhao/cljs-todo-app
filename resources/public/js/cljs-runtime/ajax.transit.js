...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__55470){
var map__55472 = p__55470;
var map__55472__$1 = (((((!((map__55472 == null))))?(((((map__55472.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55472.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55472):map__55472);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55472__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var or__4120__auto__ = type;
...
var writer = (function (){var or__4120__auto__ = new cljs.core.Keyword(null,"writer","writer",-277568236).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var reader = (function (){var or__4120__auto__ = new cljs.core.Keyword(null,"reader","reader",169660853).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
