...
var len__4730__auto___56192 = arguments.length;
var i__4731__auto___56193 = (0);
while(true){
if((i__4731__auto___56193 < len__4730__auto___56192)){
args__4736__auto__.push((arguments[i__4731__auto___56193]));

var G__56195 = (i__4731__auto___56193 + (1));
i__4731__auto___56193 = G__56195;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq56148){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56149,G__56150,seq56148__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__56159_SHARP_){
return (!((cljs.core.meta(p1__56159_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56168__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e56172){var _e__55067__auto__ = e56172;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e56175){var _e__55067__auto__ = e56175;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__56178 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__56179 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__56179);

try{var map__56180 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56180__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__56178);
}});
...
var temp__5733__auto___56241 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___56241)){
var managed_print_level_56242 = temp__5733__auto___56241;
var _STAR_print_level_STAR__orig_val__56188_56243 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__56189_56244 = managed_print_level_56242;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__56189_56244);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__56182_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__56182_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__56188_56243);
}} else {
job_fn();
}
