...
return [(function (){var pred__60788 = cljs.core.instance_QMARK_;
var expr__60789 = reactive_val;
if(cljs.core.truth_((pred__60788.cljs$core$IFn$_invoke$arity$2 ? pred__60788.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__60789) : pred__60788.call(null,reagent.ratom.RAtom,expr__60789)))){
return "ra";
} else {
if(cljs.core.truth_((pred__60788.cljs$core$IFn$_invoke$arity$2 ? pred__60788.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__60789) : pred__60788.call(null,reagent.ratom.RCursor,expr__60789)))){
return "rc";
} else {
if(cljs.core.truth_((pred__60788.cljs$core$IFn$_invoke$arity$2 ? pred__60788.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__60789) : pred__60788.call(null,reagent.ratom.Reaction,expr__60789)))){
return "rx";
} else {
if(cljs.core.truth_((pred__60788.cljs$core$IFn$_invoke$arity$2 ? pred__60788.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__60789) : pred__60788.call(null,reagent.ratom.Track,expr__60789)))){
return "tr";
} else {
return "other";
}
