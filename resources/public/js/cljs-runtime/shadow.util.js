...
while(true){
if((i__4731__auto___56492 < len__4730__auto___56490)){
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq56413){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56413));
}));
...
var len__4730__auto___56502 = arguments.length;
var i__4731__auto___56503 = (0);
while(true){
if((i__4731__auto___56503 < len__4730__auto___56502)){
args_arr__4751__auto__.push((arguments[i__4731__auto___56503]));

var G__56504 = (i__4731__auto___56503 + (1));
i__4731__auto___56503 = G__56504;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq56429){
var G__56431 = cljs.core.first(seq56429);
var seq56429__$1 = cljs.core.next(seq56429);
var G__56432 = cljs.core.first(seq56429__$1);
var seq56429__$2 = cljs.core.next(seq56429__$1);
var G__56433 = cljs.core.first(seq56429__$2);
var seq56429__$3 = cljs.core.next(seq56429__$2);
var G__56434 = cljs.core.first(seq56429__$3);
var seq56429__$4 = cljs.core.next(seq56429__$3);
var G__56436 = cljs.core.first(seq56429__$4);
var seq56429__$5 = cljs.core.next(seq56429__$4);
var G__56437 = cljs.core.first(seq56429__$5);
var seq56429__$6 = cljs.core.next(seq56429__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56431,G__56432,G__56433,G__56434,G__56436,G__56437,seq56429__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__56465){
var vec__56466 = p__56465;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56466,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56466,(1),null);
