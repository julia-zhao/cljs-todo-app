...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__55534 = cljs.core.second(format);
var G__55535 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__55534,G__55535) : ajax.easy.keyword_response_format_element.call(null,G__55534,G__55535));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__55536 = format;
var G__55536__$1 = (((G__55536 instanceof cljs.core.Keyword))?G__55536.fqn:null);
switch (G__55536__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55537_SHARP_){
return ajax.easy.keyword_response_format_element(p1__55537_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__55538){
var map__55539 = p__55538;
var map__55539__$1 = (((((!((map__55539 == null))))?(((((map__55539.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55539.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55539):map__55539);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55539__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55539__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55539__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__4120__auto__ = handler;
...
var e = (function (){var or__4120__auto__ = error_handler;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
return (function ajax$easy$transform_handler_$_easy_handler(p__55541){
var vec__55542 = p__55541;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55542,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55542,(1),null);
var fexpr__55545_55552 = (cljs.core.truth_(ok)?h:e);
(fexpr__55545_55552.cljs$core$IFn$_invoke$arity$1 ? fexpr__55545_55552.cljs$core$IFn$_invoke$arity$1(result) : fexpr__55545_55552.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__55546){
var map__55547 = p__55546;
var map__55547__$1 = (((((!((map__55547 == null))))?(((((map__55547.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55547.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55547):map__55547);
var opts = map__55547__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55547__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55547__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55547__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55547__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55547__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = (((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET")));
var rf = (cljs.core.truth_((function (){var or__4120__auto__ = format;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return needs_format;
