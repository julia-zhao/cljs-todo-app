...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__66986_SHARP_){
return reitit.frontend.query_param(q,p1__66986_SHARP_);
})),q.getKeys()));
});
/**
...
var parameters = (function (){var or__4120__auto__ = reitit.coercion.coerce_BANG_(match__$1);
...
if(cljs.core.every_QMARK_((function (p1__67029_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__67029_SHARP_);
